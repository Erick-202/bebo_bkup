#Este codigo esta basado en el de Pared.py y es para medir cuanto se mueve el dron realmente con la odometria
#!/usr/bin/env python
...
def camaraCallback(msg):
    ...
    if sistema_armado == 1:
        if estado == -2:
            ...
            if x_real < avance_at[0] + 1.1  and x_real > avance_at[0] + 0.9:
                    cmd_vel.linear.x = 0
                    cmd_vel.linear.y = 0
                    cmd_vel.linear.z = 0
                    estado = 0
