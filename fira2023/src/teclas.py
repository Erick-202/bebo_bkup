...
#CONTROL MANUAL DEL DRON MEDIANTE TECLAS
...
def camaraCallback(msg):
    ...
    if sistema_armado == 1:
        ...
        cv2.putText(frame, "ARMADO", (10, 30), cv2.FONT_HERSHEY_SIMPLEX,1, (0, 0, 255), 3)


        """
        print ("Estoy iendo pa adelante")
